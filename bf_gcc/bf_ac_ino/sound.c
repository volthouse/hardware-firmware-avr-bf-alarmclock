...
const int FurElise[] PROGMEM=   
        {
            3, 
            8,e2, 8,xd2, 8,e2, 8,xd2, 8,e2, 8,b1, 8,d2, 8,c2, 4,a1, 8,pause, 
            8,c1, 8,e1, 8,a1, 4,b1, 8,pause, 8,e1, 8,xg1, 8,b1, 4,c2, 8,pause, 8,e1, 
            8,e2, 8,xd2, 8,e2, 8,xd2, 8,e2, 8,b1, 8,d2, 8,c2, 4,a1, 8,pause, 8,c1, 
            8,e1, 8,a1, 4,b1, 8,pause, 8,e1, 8,c2, 8,b1, 4,a1, 
            0, 1
        };
...
const int AuldLangSyne[] PROGMEM = 
        {  
            ...
            8,c3, 4,e3, 4,g3, 2,a3, 8,pause, 4,a3, 2,g3, 8,e3, 4,e3, 4,c3, 2,d3, 
            8,c3, 4,d3, 8,e3, 8,d3, 2,c3, 8,a2, 4,a2, 4,g2, 2,c3, 4,pause,
            0, 1
        };
...
const int Whistle[] PROGMEM = 
        {
            ...
            32,120, 32,115, 32,110, 32,105, 32,100, 8,pause, 32,200, 32,195, 
...
void Play_Tune(void)
{
    ...
    if(!Tempo)
    {
        ...
        else if(pgm_read_word(pSong + Tone))  // If not the end of the song
        {
            ...
            if( (temp_tone == pause) || (temp_tone == pause) ) // if pause
